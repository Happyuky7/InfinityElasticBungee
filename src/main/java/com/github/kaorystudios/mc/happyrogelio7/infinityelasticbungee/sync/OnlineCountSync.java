...
import com.github.kaorystudios.mc.happyrogelio7.infinityelasticbungee.sync.results.OnlineCountSyncResult;
...
public class OnlineCountSync implements Listener, RedisSubscription {
    ...
    public OnlineCountSync(final InfinityElasticBungee plugin) {
        this.plugin = plugin;
